...
from app.document.views import (
    HomeView, ConfirmView, ChangeDocumentStatusView, ShipmentListView,
    ShipmentAddView, DeliveryListView, DeliveryAddView, DocumentView
)
...
urlpatterns = [
    ...
    path(
        'document/<int:pk>/changestatus/<str:status>',
